...
import static ca.tweetzy.flight.files.comments.format.YamlCommentFormatterConfiguration.DEFAULT_COMMENT_PREFIX;
import static ca.tweetzy.flight.files.utils.StringUtils.BLANK_LINE;
