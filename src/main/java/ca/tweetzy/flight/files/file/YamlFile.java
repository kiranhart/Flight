...
import ca.tweetzy.flight.files.comments.format.YamlHeaderFormatter;
...
import ca.tweetzy.flight.files.configuration.file.FileConfiguration;
import ca.tweetzy.flight.files.configuration.file.FileConfigurationOptions;
import ca.tweetzy.flight.files.exceptions.InvalidConfigurationException;
import ca.tweetzy.flight.files.implementation.SimpleYamlImplementation;
import ca.tweetzy.flight.files.implementation.api.QuoteValue;
import ca.tweetzy.flight.files.implementation.api.YamlImplementation;
import ca.tweetzy.flight.files.implementation.api.YamlImplementationCommentable;
...
public class YamlFile extends YamlConfiguration implements Commentable {
    ...
    public void addSetting(@NonNull ConfigSetting setting) {
